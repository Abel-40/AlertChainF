  ...
  // Auth routes (with animated background layout)
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: 'Select Your Assets', module: 'alerts' },
      },
    ],
  },
    ...
    children: [
      {
        ...
        meta: { requiresAuth: true, title: 'Dashboard', module: 'alerts' },
      },
      {
        path: 'assets/search',
        name: 'AssetSearch',
        component: AssetSearchView,
        meta: { requiresAuth: true, title: 'Asset Discovery', module: 'alerts' },
      },
      {
        path: 'assets/:coingecko_id',
        name: 'AssetDetail',
        component: AssetDetailView,
        meta: { requiresAuth: true, title: 'Asset Details', module: 'alerts' },
      },
      {
        path: 'assets/:coingecko_id/more',
        name: 'AssetMoreDetails',
        component: AssetMoreDetailsView,
        meta: { requiresAuth: true, title: 'Asset Full Details', module: 'alerts' },
      },
      {
        path: 'alerts',
        name: 'Alerts',
        component: AlertsView,
        meta: { requiresAuth: true, title: 'Price Alerts', module: 'alerts' },
      },
      {
        path: 'notifications',
        name: 'Notifications',
        component: NotificationsView,
        meta: { requiresAuth: true, title: 'Notifications', module: 'alerts' },
      },
      {
        path: 'notifications/:id',
        name: 'NotificationDetail',
        component: NotificationDetailView,
        meta: { requiresAuth: true, title: 'Notification Details', module: 'alerts' },
      },
      {
        path: 'profile',
        name: 'Profile',
        component: ProfileView,
        meta: { requiresAuth: true, title: 'Profile Settings', module: 'alerts' },
      },
    ],
  },
